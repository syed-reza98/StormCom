...
async function getBrands(searchParams: Awaited<BrandsPageProps['searchParams']>): Promise<{
  brands: Brand[];
  totalCount: number;
  totalPages: number;
}> {
...
export default async function BrandsPage({ searchParams: searchParamsPromise }: BrandsPageProps) {
