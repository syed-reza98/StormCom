# PowerShell script to run lint and save errors to JSON
# Usage: .\scripts\collect-lint-errors.ps1

$ErrorActionPreference = "Continue"
$outputFile = "lint-errors.json"
...
try {
    ...
    Write-Host "`nLint results saved to $outputFile" -ForegroundColor Green
